...
Route::group(['middleware' => 'auth'], function () {
	...
	Route::get('/hrm/notice/edit/{id}', 'NoticeController@edit')->name('editnotice');
	Route::post('/hrm/notice//update/{id}', 'NoticeController@update')->name('updatenotice');
...
//jobs//
	Route::get('/job/all', 'JobController@listofAllJobs')->name('jobindex');
	Route::get('job/candidates', 'JobController@listofAllAppliedCandidates')->name('jobcandi');
	Route::get('candidates/approved{id}', 'JobController@CanditeApproved')->name('cand_app');
	Route::get('candidates/notpproved{id}', 'JobController@CanditeNotApproved')->name('cand_not_app');
	Route::get('/candidates/download-pdf/{id}', 'JobController@DownloadFile')->name('download_pdf');
    Route::get('/job/create', 'JobController@create')->name('c_job');
	Route::post('/job/store', 'JobController@store')->name('jobstore');
	Route::get('tasks/Approved', 'TaskController@TasksCompleted')->name('taskcom');
	//Tasks managements//
	Route::get('/tasks/create', 'TaskController@create')->name('tcreat');
	Route::get('tasks/all', 'TaskController@allTasks')->name('tall');
	Route::get('all/tasks', 'TaskController@allTasksForSingle')->name('taskall');
	Route::get('tasks/completed{id}', 'TaskController@TasksCompleted')->name('taskcom');
	Route::get('tasks/pending{id}', 'TaskController@TasksPending')->name('taskpend');
    Route::post('/tasks/store', 'TaskController@store')->name('tstore');
	//expence managements//
