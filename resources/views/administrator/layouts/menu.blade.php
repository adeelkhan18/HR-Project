<div id="mainMenu">
    <ul class="sidebar-menu" data-widget="tree">
       ...
       @permission('file-upload')
        ...
        <li class="treeview">
            <a href="#">
                <i class="fa fa-users text-purple"></i> <span>{{ __('Jobs Management') }}</span>
                <span class="pull-right-container">
                    <i class="fa fa-angle-left pull-right"></i>
                </span>
            </a>
            <ul class="treeview-menu">
                <li><a href="{{ route('c_job') }}"><i class="fa fa-circle-o"></i>{{ __(' New job') }}</a></li>
                <li><a href="{{ route('jobindex') }}"><i class="fa fa-circle-o"></i> {{ __('All Jobs') }}</a></li>
                <li><a href="{{ route('jobcandi') }}"><i class="fa fa-circle-o"></i> {{ __('All Candidates') }}</a></li>
