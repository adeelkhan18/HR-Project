...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">{{ __('Edit Notice') }}</li>
    </ol>
  </section>
  ...
  <section class="content">
    ...
    <div class="box box-default">
      <div class="box-header with-border">
        <h3 class="box-title">{{ __('Edit Notice') }}</h3>
      ...
      <!-- /.box-header -->
      <form action="{{route('updatenotice',$notice['id'])}}" method="post" name="notice_edit_form">
        {{ csrf_field() }}
        <div class="box-body">
          <div class="row">
            <!-- Notification Box -->
            ...
            <div class="col-md-6">
              ...
              <div class="form-group{{ $errors->has('notice_title') ? ' has-error' : '' }} has-feedback">
                <input type="text" name="notice_title" id="notice_title" class="form-control" value="{{$notice['notice_title']}}" >
        ...
        <div class="box-footer">
          ...
          <button type="submit" class="btn btn-primary btn-flat"><i class="icon fa fa-plus"></i> {{ __('Edit Notice') }}</button>
        </div>
      </form>
    </div>
    <!-- /.box -->
