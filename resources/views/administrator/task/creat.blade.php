...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a>{{ __('Tasks') }}</a></li>
      <li class="active">{{ __('create Tasks') }}</li>
    </ol>
  </section>
  ...
  <section class="content">
    ...
    <div class="box">
      <div class="box-header with-border">
        <h3 class="box-title">{{ __('Create Tasks') }}</h3>
        ...
        <div class="col-md-12">
          ...
          <form class="form-horizontal" action="{{ url('/tasks/store') }}" method="post">
            ...
            <div class="form-group{{ $errors->has('user_id') ? ' has-error' : '' }}">
              ...
              <div class="form-group{{ $errors->has('user_id') ? ' has-error' : '' }}">
              <label for="user_id" class="col-sm-3 control-label">{{ __('Task Detail') }}</label>
              <div class="col-sm-6">
              ...
              <div class="form-group">
                <div class="col-sm-offset-3 col-sm-10">
                  <button type="submit" class="btn btn-primary btn-flat"><i class="fa fa-arrow-right"></i>{{ __('Add Task') }} </button>
                </div>
              </div>
              <!-- /.end group -->
            </form>
