...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo url('/hrm/deddeduction'); ?>"><?php echo __('Manage Deductiones'); ?></a></li>
            <li class="active"><?php echo __('Add Deduction'); ?></li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box box-default">
            <div class="box-header with-border">
                <h3 class="box-title"><?php echo __('Add Deduction'); ?></h3>
            ...
            <!-- /.box-header -->
            <form action="<?php echo url('/hrm/deductions/store'); ?>" method="post" name="deduction_add_form">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group<?php echo $errors->has('deduction_name') ? ' has-error' : ''; ?> has-feedback">
                                <input type="text" name="deduction_name" id="deduction_name" class="form-control" value="<?php echo old('deduction_name'); ?>" placeholder="<?php echo __('Enter deduction name..'); ?>">
                            ...
                            <div class="form-group<?php echo $errors->has('deduction_amount') ? ' has-error' : ''; ?> has-feedback">
                                <input type="number" name="deduction_amount" id="deduction_amount" class="form-control" value="<?php echo old('deduction_amount'); ?>" placeholder="<?php echo __('Enter deduction name..'); ?>">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group<?php echo $errors->has('deduction_description') ? ' has-error' : ''; ?> has-feedback">
                                <textarea class="textarea text-description" name="deduction_description" id="deduction_description" placeholder="<?php echo __('Enter client description..'); ?>"><?php echo old('deduction_description'); ?></textarea>
                ...
                <div class="box-footer">
                    ...
                    <button type="submit" class="btn btn-primary btn-flat"><i class="icon fa fa-plus"></i> <?php echo __('Add deduction'); ?></button>
                </div>
            </form>
        </div>
        <!-- /.box -->
