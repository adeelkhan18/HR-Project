...
<html>
    ...
    <body class="hold-transition login-page">
       <a href="<?php echo route('index'); ?>" title="" class="btn btn-success" style="margin-left: 20px; margin-top:20px">Home</a>
        <div class="login-box">
            <div class="login-logo">
                <a><b><?php echo __('HRMS For Centagle Interactive '); ?></b></a>
            </div>
            <!-- /.login-logo -->
