...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a><?php echo __('Performance'); ?></a></li>
            <li class="active"><?php echo __('Performance'); ?></li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title"><?php echo __('Employee Performance'); ?></h3>
                ...
                <table  class="table table-bordered table-striped">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo __('Pending task'); ?></th>
                    ...
                    <tbody id="myTable">
                        ...
                        <tr>
                            ...
                            <td><?php echo $data['completed_task']; ?></td>
                            <td><?php echo $data['pending_task']; ?></td>
