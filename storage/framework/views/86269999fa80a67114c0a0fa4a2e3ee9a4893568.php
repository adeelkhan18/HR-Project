...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><?php echo __(' Edit Bonus'); ?></li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box box-default">
            <div class="box-header with-border">
                <h3 class="box-title"><?php echo __(' Edit Bonus'); ?></h3>
            ...
            <!-- /.box-header -->
            <form action="<?php echo url('/hrm/bonuses/update/' . $bonus['id']); ?>" method="post" name="bonus_add_form">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group<?php echo $errors->has('bonus_name') ? ' has-error' : ''; ?> has-feedback">
                                <input type="text" name="bonus_name" id="bonus_name" class="form-control" value="<?php echo $bonus['bonus_name']; ?>" placeholder="<?php echo __('Enter bonus name..'); ?>">
                            ...
                            <div class="form-group<?php echo $errors->has('bonus_month') ? ' has-error' : ''; ?> has-feedback">
                                <div class="input-group date">
                                    ...
                                    <input type="text" name="bonus_month" class="form-control pull-right" value="<?php echo $bonus['bonus_month']; ?>" id="monthpicker2">
                                </div>
                            ...
                            <div class="form-group<?php echo $errors->has('bonus_amount') ? ' has-error' : ''; ?> has-feedback">
                                <input type="text" name="bonus_amount" id="bonus_amount" class="form-control" value="<?php echo $bonus['bonus_amount']; ?>" placeholder="<?php echo __('Enter bonus name..'); ?>">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group<?php echo $errors->has('bonus_description') ? ' has-error' : ''; ?> has-feedback">
                                <textarea class="textarea text-description" name="bonus_description" id="bonus_description" placeholder="<?php echo __('Enter client description..'); ?>"><?php echo $bonus['bonus_description']; ?></textarea>
                ...
                <div class="box-footer">
                    ...
                    <button type="submit" class="btn btn-primary btn-flat"><i class="icon fa fa-edit"></i> <?php echo __('Update bouns'); ?></button>
                </div>
            </form>
        </div>
        <!-- /.box -->
...
<script type="text/javascript">
    document.forms['bonus_add_form'].elements['user_id'].value = "<?php echo $bonus['user_id']; ?>";
</script>
