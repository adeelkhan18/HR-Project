    ...
    <section class="content">
        ...
        <div class="box box-default">
            <div class="box-header with-border">
                <h3 class="box-title"><?php echo __('Edit designation'); ?></h3>
            ...
            <!-- /.box-header -->
            <form action="<?php echo url('/setting/designations/update/'. $designation['id']); ?>" method="post" name="designation_edit_form">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group<?php echo $errors->has('designation') ? ' has-error' : ''; ?> has-feedback">
                                <input type="text" name="designation" id="designation" class="form-control" value="<?php echo $designation['designation']; ?>">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group<?php echo $errors->has('designation_description') ? ' has-error' : ''; ?> has-feedback">
                                <textarea class="textarea text-description" name="designation_description" id="designation_description"><?php echo $designation['designation_description']; ?></textarea>
                                <?php if($errors->has('designation')): ?>
                                <span class="help-block">
                ...
                <div class="box-footer">
                    ...
                    <button type="submit" class="btn btn-primary btn-flat"><i class="icon fa fa-edit"></i> <?php echo __('Update designation'); ?></button>
                </div>
            </form>
        </div>
        <!-- /.box -->
...
<script type="text/javascript">
    document.forms['designation_edit_form'].elements['publication_status'].value = "<?php echo $designation['publication_status']; ?>";
    document.forms['designation_edit_form'].elements['department_id'].value = "<?php echo $designation['department_id']; ?>";
</script>
