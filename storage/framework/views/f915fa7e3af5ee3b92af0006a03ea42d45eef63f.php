...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><?php echo __('Add department'); ?></li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box box-default">
            <div class="box-header with-border">
                <h3 class="box-title"><?php echo __('Add department'); ?></h3>
            ...
            <!-- /.box-header -->
            <form action="<?php echo url('setting/departments/store'); ?>" method="post" name="department_add_form">
                <?php echo csrf_field(); ?>
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <?php else: ?>
                                <p class="text-yellow"><?php echo __('Enter department details. All field are required.'); ?> </p>
                            <?php endif; ?>
                        </div>
                        <!-- /.Notification Box -->
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group<?php echo $errors->has('department') ? ' has-error' : ''; ?> has-feedback">
                                <input type="text" name="department" id="department" class="form-control" value="<?php echo old('department'); ?>" placeholder="<?php echo __('Enter client name..'); ?>">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group<?php echo $errors->has('department_description') ? ' has-error' : ''; ?> has-feedback">
                                <textarea class="textarea text-description" name="department_description" id="department_description" placeholder="<?php echo __('Enter client description..'); ?>"><?php echo old('department_description'); ?></textarea>
                                <?php if($errors->has('department')): ?>
                                <span class="help-block">
                ...
                <div class="box-footer">
                    ...
                    <button type="submit" class="btn btn-primary btn-flat"><i class="icon fa fa-plus"></i> <?php echo __('Add departmen'); ?>t</button>
                </div>
            </form>
        </div>
        <!-- /.box -->
...
<script type="text/javascript">
    document.forms['department_add_form'].elements['publication_status'].value = "<?php echo old('publication_status'); ?>";
</script>
