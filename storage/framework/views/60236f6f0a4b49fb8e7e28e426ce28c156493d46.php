...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active"><?php echo __('create Tasks'); ?></li>
    </ol>
  </section>
  ...
  <section class="content">
    ...
    <div class="box">
      <div class="box-header with-border">
        <h3 class="box-title"><?php echo __('Create Tasks'); ?></h3>
    ...
    <div class="alert alert-danger alert-dismissible" id="notification_box">
                                ...
                                <i class="icon fa fa-check"></i> <?php echo $error; ?>
  ...
  <?php endif; ?>
      ...
      <div class="box-body">
        ...
        <div class="col-md-12">
          ...
          <form class="form-horizontal" action="<?php echo url('/tasks/store'); ?>" method="post">
            <?php echo csrf_field(); ?>
            ...
            <div class="form-group<?php echo $errors->has('user_id') ? ' has-error' : ''; ?>">
              ...
              <div class="form-group<?php echo $errors->has('user_id') ? ' has-error' : ''; ?>">
              <label for="user_id" class="col-sm-3 control-label"><?php echo __('Task Detail'); ?></label>
              <div class="col-sm-6">
              ...
              <div class="form-group">
                <div class="col-sm-offset-3 col-sm-10">
                  <button type="submit" class="btn btn-primary btn-flat"><i class="fa fa-arrow-right"></i><?php echo __('Add Task'); ?> </button>
                </div>
              </div>
              <!-- /.end group -->
            </form>
