...
class FrontEndController extends Controller {
	...
	public function careers() {
		...
		return view('Frontend.homepage.carrers', compact('Job'));
	}
	...
	public function jobDetail($id) {
		...
		return view('Frontend.homepage.jobdetail', compact('data'));
	}
	public function SaveJobs(Request $request) {
		...
		if($request->hasFile('cv')) {
            ...
            $image = $file->move('public/CVs', $name);
        }
		$employee = new AppliedCandidates;
		$employee->name = $request->get('name');
		$employee->jobid = $request->get('id');
	...
	public function applyJobs($id) {
		...
		$job = Job::find($id);
		$title=$job->title;
		return view('Frontend.homepage.applyjob',compact('id','title')); 
	}
