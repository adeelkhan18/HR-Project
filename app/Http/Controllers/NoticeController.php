...
public function show() {
	...
	public function edit($id) {
        ...
        return view('administrator.hrm.notice.edit_notice', compact('notice'));
	}
	...
	public function update(Request $request, $id) {
        ...
        $notice->notice_title = $request->get('notice_title');
        $notice->description = $request->get('description');
        $notice->publication_status = $request->get('publication_status');
        $affected_row = $notice->save();

        if (!empty($affected_row)) {
            return redirect('/hrm/notice/')->with('message', 'Update successfully.');
        }
        return redirect('/hrm/notice/')->with('exception', 'Operation failed !');
	}
